...
void cab_add(int& day, int& month, int& year) {
repeat:	switch (month)
{
case 1:case 3:case 5:case 7:case 8:case 10:case 12:
	if (day > 31) {
...
void Date::setDay(int day) {
	if (check(day, this->month, this->year)) {
		this->day = day;
	}
}
void Date::setMonth(int month) {
	if (check(this->day, month, this->year)) {
		this->month = month;
	}
}
void Date::setYear(int Year) {
	if (check(this->day, this->month, year)) {
		this->year = year;
	}
}
int Date::getDay() {
...
void Date::add(int day) {
	this->day += day;
	cab_add(this->day, this->month, this->year);
}
void Date::sub(int day) {
	this->day -= day;
	cab_sub(this->day, this->month, this->year);
}
